...
import main.java.com.streamanalytix.extensions.utility.MongoConfigConstant;
import main.java.com.streamanalytix.extensions.utility.MongoOperationUtilImpl;
...
public class MongoDBRDDBulkExecutor implements RDDProcessor, MongoConfigConstant {
     ...
     *
     * @param configMap
     *            ***this is for getting the configuration from front - end** */
    ...
    public RDD<JSONObject> process(RDD<JSONObject> rdd, Map<String, Object> configMap) {
        ...
        return rdd.toJavaRDD().mapPartitions(new FlatMapFunction<Iterator<JSONObject>, JSONObject>() {
            ...
            public Iterable<JSONObject> call(Iterator<JSONObject> partition) throws Exception {
